...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    _future = Supabase.instance.client.from('products').select().then(
      ...
      body: SafeArea(
        child: FutureBuilder<List<Map<String, dynamic>>>(
          ...
          builder: (context, snapshot) {
            ...
            // Сортировка товаров по убыванию количества просмотров
            products.sort((a, b) => (b['view_count'] as int).compareTo(a['view_count'] as int));

            return SingleChildScrollView(
              child: Column(
                children: [
                  // Text with padding and medium-bold font weight
                  const Padding(
